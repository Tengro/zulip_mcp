 ...
 *   ZULIP_UPLOAD_MAX_BYTES                      - per-file ceiling for outbound uploads (25MiB, Zulip Cloud's default)
...
import { createZulipUploader, resolveUploadMaxBytes } from './uploads.js';
...
async function main(): Promise<void> {
  ...
  const tools = new ZulipToolRuntime(session, stateDir, { uploader, uploadMaxBytes });
